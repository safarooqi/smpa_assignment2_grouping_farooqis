...
1.  What is the most common type of payment/purchase the Trump campaign made?

2.  How often did they pay for legal consultations? (would need datasets of other candidates to see if that is comparatively above or below average)

3.  Were the entity recipients more often individuals or organizations?
...
payments %>% 
  ...
  summarise(sum = sum(disbursement_amount, na.rm = TRUE)) %>% 
  arrange(desc(sum))
